 ...
 * @colorTintRange - object with DynamicRange values for RGB color tinting
 * @colorTintTimes - Range: number of color tint cycles
    ...
    constructor(
        {
            ...
            colorTintRange = {
                redRange: new DynamicRange(new Range(0.5, 0.6), new Range(0.7, 0.8)),
                greenRange: new DynamicRange(new Range(0.5, 0.6), new Range(0.7, 0.8)),
                blueRange: new DynamicRange(new Range(1.0, 1.25), new Range(1.5, 2)),
            },
            colorTintTimes = new Range(2, 8),
